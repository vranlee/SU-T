...
def make_parser():
    parser = argparse.ArgumentParser("MFT25 ReID dataset")

    parser.add_argument("--data_path", default="", help="path to MOT data")
    parser.add_argument("--save_path", default="fast_reid/datasets", help="Path to save the MFT25-ReID dataset")
    parser.add_argument("--mot", default=25, help="Do not modify this value. It is the version of MFT dataset.")
...
def main(args):
    ...
    save_path = os.path.join(args.save_path, 'MFT' + str(args.mot) + '-ReID')
    ...
    # Get gt data
    data_path = os.path.join(args.data_path, 'MFT' + str(args.mot), 'train')
