...
class PatchEmbed(nn.Module):
    ...
    # def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768): #vran
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=2048):
        super().__init__()
...
class HybridEmbed(nn.Module):
    ...
    def __init__(self, backbone, img_size=224, feature_size=None, in_chans=3, embed_dim=2048): #vran
        super().__init__()
...
class PatchEmbed_overlap(nn.Module):
    ...
    # def __init__(self, img_size=224, patch_size=16, stride_size=20, in_chans=3, embed_dim=768): vran
    def __init__(self, img_size=224, patch_size=16, stride_size=20, in_chans=3, embed_dim=2048):
        super().__init__()
        img_size = to_2tuple(img_size)
        patch_size = to_2tuple(patch_size)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride_size=16, in_chans=3, embed_dim=2048, #vran
